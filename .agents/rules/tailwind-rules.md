# Tailwind CSS & Frontend Coding Rules

These rules are enforced across the workspace:
...
## 6. General
- Use Tailwind CSS utilities; avoid raw inline styles and raw custom CSS rules wherever Tailwind provides a utility.
